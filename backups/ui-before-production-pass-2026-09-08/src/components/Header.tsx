...
export function Header({ muted, isDark, hasPeers, isInstallable, isEcoMode, onToggleEcoMode, onInstall, onToggleMute, onToggleTheme, onShowHistory, onShowQR }: HeaderProps) {
  ...
  return (
    <header className="header">
      <div className="logo">
        ...
        >
          <div className="brand-horse-wrapper">
            ...
            <Image className="brand-horse" src="/zensend-z-horse.png" alt="ZenSend Logo" width={48} height={48} priority />
          </div>
          <div className="logo-brand-col">
            <div className="logo-text-row">
              <span className="logo-zen">Zen</span>
              <span className="logo-send">
                Send<span className="logo-sparkle" aria-hidden="true">✦</span>
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="header-actions">
        ...
        <div className="header-more-container" ref={menuRef}>
          <button
            type="button"
